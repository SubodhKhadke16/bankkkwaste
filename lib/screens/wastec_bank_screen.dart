...
class _RouteStops extends StatelessWidget {
  const _RouteStops(
      {required this.pickup, required this.drop, required this.notes});
...
class _DriverCard extends StatelessWidget {
  const _DriverCard(
      {required this.name, required this.vehicle, required this.contact});
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
                        color: WastecColors.primaryGreen.withOpacity(0.4)),
                  ),
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            valueColor:
                const AlwaysStoppedAnimation<Color>(WastecColors.primaryGreen),
          ),
        ),
